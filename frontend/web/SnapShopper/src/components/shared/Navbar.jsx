  ...
  return (
    <>
      ...
      >
        ...
        {/* <div className={`bg-zinc-50 border-b border-zinc-100 transition-all duration-300 ${scrolled ? "hidden" : "block"
          } hidden lg:${scrolled ? "hidden" : "block"}`}> */}

          <div className={`transition-all duration-300 ${scrolled ? "hidden" : "hidden lg:block"
            ...
            <div className="max-w-7xl mx-auto px-4 py-2">
              <div className="flex justify-between items-center text-sm text-zinc-600">
                <div className="flex space-x-6">
                  ...
                  <Link to="/vendor/auth" className="hover:text-blue-600 transition-colors">
                    Sell as a Vendor
                  </Link>
                </div>
                <div className="flex space-x-4">
                  <Link to="/track-order" className="hover:text-blue-600 transition-colors">
                    Track Order
                  </Link>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="flex items-center justify-between h-16 lg:h-20 w-full gap-4 lg:gap-6">
              ...
              <div className="flex items-center flex-shrink-0 min-w-fit">
                <Link className="flex items-center group" to={"/"}>
                  ...
                  <span className="ml-2 lg:ml-3 font-bold text-zinc-900 text-base lg:text-xl tracking-tight whitespace-nowrap">
                    SNAPPSHOPPER
                  </span>
                </Link>
              </div>

              {/* Desktop Navigation - Expanded for better spacing */}
              <div className="hidden lg:flex items-center flex-1 justify-center max-w-5xl">
                <div className="flex items-center justify-between w-full">
                  ...
                  <div className="flex items-center space-x-8 xl:space-x-10">
                    ...
                    <Link
                      to="/home"
                      className="relative px-6 py-3 text-blue-600 font-medium rounded-full transition-all duration-300 
                             hover:bg-blue-50 hover:text-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300 
                             focus:ring-offset-2 group"
                    >
                      <span className="text-base">Home</span>
                      <div
                        className="absolute bottom-1 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-blue-600 
                    ...
                    <div className="relative">
                      <button
                        className="flex items-center px-6 py-3 font-medium text-zinc-700 rounded-full transition-all 
                  ...
                  {/* Enhanced Search Bar - Much Longer */}
                  <div className="flex-1 max-w-5xl mx-8 xl:mx-12">
                    <div
                      className={`relative flex items-center transition-all duration-300 ${searchFocused ? "transform scale-[1.02]" : ""
                        }`}
                    >
                      <div
                        className={`flex items-center w-full border rounded-full px-5 py-3 bg-white 
                      ...
                      >
                        <FiCamera
                          className="h-5 w-5 text-zinc-400 mr-4 cursor-pointer hover:text-blue-500 
                        ...
                        <input
                          ...
                          className="flex-1 outline-none text-sm text-zinc-900 placeholder:text-zinc-500 bg-transparent min-w-0"
                          onFocus={() => setSearchFocused(true)}
                          onBlur={() => setSearchFocused(false)}
                        />
                        <button className="ml-4 p-2 text-zinc-400 hover:text-blue-500 transition-colors rounded-full hover:bg-blue-50 flex-shrink-0">
              ...
              <div className="hidden md:flex lg:hidden items-center flex-1 justify-center max-w-lg">
                {/* Compact Search for medium screens */}
              ...
              {/* Right Side Icons - Improved spacing */}
              <div className="flex items-center space-x-3 lg:space-x-4 min-w-fit">

                {/* Mobile Search Icon */}
                <button className="md:hidden p-2.5 text-zinc-600 hover:text-blue-600 hover:bg-blue-50 rounded-full transition-colors">
                ...
                <div className="relative">
                  <button
                    className="relative p-2.5 text-zinc-600 hover:text-blue-600 hover:bg-blue-50 rounded-full 
                ...
                <div className="relative hidden sm:block">
                  <button
                    className="flex items-center space-x-3 px-3 lg:px-4 py-2.5 text-zinc-600 hover:text-blue-600 hover:bg-blue-50 
                ...
                <button
                  ...
                  className="md:hidden p-2.5 text-zinc-600 hover:text-blue-600 hover:bg-blue-50 rounded-full 
                         transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-300"
                >
                  {mobileMenuOpen ? (
          ...
          >
              ...
              <div className="flex items-center">
                ...
                <div>
                  {authUser ? (
                    ...
                    <div className="font-semibold text-zinc-900">Hello, Sign in</div>
                  )}
                </div>
              </div>
              <button
            ...
            <div className="p-6 space-y-4">
              <Link
                to="/home"
                className="flex items-center py-4 px-5 text-blue-600 font-medium bg-blue-50 rounded-xl 
              ...
              <button
                className="flex items-center justify-between w-full py-4 px-5 text-zinc-700 font-medium 
                       hover:bg-zinc-50 rounded-xl transition-colors cursor-pointer"
                onClick={categoriesDropdown.toggleDropdown}
              >
                <span className="text-base">Categories</span>
                <svg
              ...
              <div className="grid grid-cols-2 gap-4 pt-6">
                <button className="flex flex-col items-center p-5 bg-zinc-50 rounded-xl hover:bg-zinc-100 transition-colors">
                  <FaBell className="h-6 w-6 text-zinc-600 mb-3" />
                  <span className="text-sm font-medium text-zinc-700">
                    Notifications
                  </span>
                </button>
                <button className="flex flex-col items-center p-5 bg-zinc-50 rounded-xl hover:bg-zinc-100 transition-colors">
                  <FaShoppingCart className="h-6 w-6 text-zinc-600 mb-3" />
