...
import { FaBars, FaBell, FaShoppingCart, FaTimes, FaUser, FaSearch } from 'react-icons/fa'
...
const Navbar = () => {
  ...
  return (
    <>
      <nav className={`bg-white border-b border-zinc-200 sticky top-0 z-50 transition-all duration-300 ${
          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="flex items-center flex-shrink-0">
              <Link className="flex items-center group" to={"/"}>
                <div className="relative">
                  <svg className="h-8 w-8 lg:h-10 lg:w-10 text-blue-600 group-hover:text-blue-700 transition-colors" 
            ...
            <div className="hidden md:flex items-center space-x-8 flex-1 justify-center max-w-2xl">
              ...
              <Link to="/home"
                ...
                <span>Home</span>
                <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-blue-600 
              ...
              <div className="relative">
                <button
                  ...
                  <svg className={`ml-2 h-4 w-4 transition-transform duration-300 ${
              ...
              <div className="flex-1 max-w-lg">
                <div className={`relative flex items-center transition-all duration-300 ${
                  ...
                  <div className={`flex items-center w-full border rounded-full px-4 py-2.5 bg-white 
            ...
            <div className="flex items-center space-x-2 lg:space-x-4">
              ...
              <div className="relative">
                <button
                  ...
                  <span className="absolute -top-1 -right-1 bg-red-500 text-white rounded-full text-xs 
                                 w-5 h-5 flex items-center justify-center font-medium shadow-sm 
                                 animate-pulse">9</span>
                </button>
              ...
              <div className="relative">
                <button
                  ...
                  <span className="absolute -top-1 -right-1 bg-blue-600 text-white rounded-full text-xs 
                                 w-5 h-5 flex items-center justify-center font-medium shadow-sm">3</span>
                </button>
        ...
        <div className={`fixed top-0 right-0 h-full w-80 max-w-[90vw] bg-white shadow-2xl z-50 
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              <Link className="flex flex-col items-center p-4 bg-zinc-50 rounded-lg hover:bg-zinc-100 transition-colors">
